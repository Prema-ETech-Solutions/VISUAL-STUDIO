...
Public Class Internet
    ...
    Shared Function connection() As Boolean
        ...
        End Try
    End Function
    Shared Function Sendemail(ByVal otp As Integer, ByVal email As String) As Boolean
        Try
            ...
            e_mail.Body = "Welcome To SPACETECH BOOK STORE! Your verification code is" & otp & ". Please use this OTP and reset the password. Don't Share The OTP "
