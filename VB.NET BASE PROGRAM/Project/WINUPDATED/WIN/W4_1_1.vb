Public Class W4_1_1
    Private Sub W4_1_1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub Value2()
        Dim per As String = "%"
        Dim temp As String = ProgressBar1.Value
        Dim t2 As String = temp + per
